...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        {
            Departure="Tunis",AirlineLogo="abc",
     ...
     //  ,
        ...
        public static Flight flight2 = new Flight { Departure = "Tunis", AirlineLogo = "abc", FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
        public static Flight flight3 = new Flight { FlightDate = new DateTime(2022, 02, 02, 5, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 02, 6, 40, 10), EstimatedDuration = 100, Plane = BoingPlane };
